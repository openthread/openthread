...
| `device/cc13x2_cc26x2/driverlib/bin/gcc/driverlib.a` | Renamed from `driverlib.lib` to allow Automake to recognize the library |
| `device/cc26x0/linker_files/cc26x0f128.lds`          | `end` symbol added for GCC stdlib                                       |
| `device/cc13x2_cc26x2/linker_files/cc26x2r1f.lds`    | `end` symbol added for GCC stdlib                                       |
| `device/cc26x0/startup_files/startup_gcc.c`          | C++ constructor calls added to `ResetHandler`                           |
| `device/cc13x2_cc26x2/startup_files/startup_gcc.c`   | C++ constructor calls added to `ResetHandler`                           |

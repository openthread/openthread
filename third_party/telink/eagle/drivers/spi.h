...
typedef enum
{
    ...
    SPI_READ_DATA_AND_ADDR_DUL_4CYC_CMD =
...
/**
 * @brief This function servers to set xip timeout cnt,when two data frame intervals exceed
 * spi_clock_out_period*timeout_cnt,cs will set high level.
...
/**
 * @brief This function servers to reply master slave is ready .When slave is ready,  slave ready reply a byte
 * data:0x5a.   indicating that slave is ready for data transmission.
 * @param[in] none:
 * @return none
 */
...
/**
 * @brief This function servers to reply master slave is not ready.slave reply a byte data: 0x00.indicating that slave
 ...
 * @return     none
 */
void spi_master_write_dma_plus(spi_sel_e          spi_sel,
                               u8                 cmd,
                               u32                addr,
                               u8 *               src_addr,
                               u32                data_len,
 ...
 * @return     none
 */
void spi_master_read_dma_plus(spi_sel_e          spi_sel,
                              u8                 cmd,
                              u32                addr,
                              u8 *               dst_addr,
                              u32                data_len,

 ...
 *      exception handling when #NL_ASSERT_PRODUCTION is enabled.
 *
 */
...
/**
 *  @implements nlSTATIC_ASSERT(aCondition)
 *
 */
#define nlSTATIC_ASSERT(aCondition)                                             __nlASSERT_UNUSED(aCondition)

/**
 *  @implements nlSTATIC_ASSERT_PRINT(aCondition, aMessage)
 *
 */
#define nlSTATIC_ASSERT_PRINT(aCondition, aMessage)                             __nlASSERT_UNUSED(aCondition)
